<?php
      ...
      ?>
        ...
        <div id="all-output" class="col-md-10">
            <h1 class="new-video-title"><i class="fa fa-bolt"></i> Favorites</h1>
            <div class="row">

                <?php
                $email=$_SESSION["email"];
$res=mysqli_query($con,"select * from video v,user u,favorites f where f.email='$email' and f.vid=v.vid and v.email=u.email");
